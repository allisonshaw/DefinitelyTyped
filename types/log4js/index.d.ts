...
declare module "log4js" {
    ...
    interface CategoryConfig {
        ...
        appenders: string[];
        /** the minimum log level that this category will send to the appenders */
        level: string;
    }

    export interface IConfig {
        /** a map of named appenders to appender definitions */
        appenders: {
            [name: string]: AppenderConfig;
        };
        /**
         * a map of named categories (string) to category definitions (object)
    ...
    /** appender definitions must have a property type; specific appender types have own properties */
    ...
    export type Appender = (event: LogEvent) => void;
    ...
    export type LayoutGenerator = (config?: LayoutConfig) => Layout;

    export type Layout = (event: LogEvent) => string;
}
